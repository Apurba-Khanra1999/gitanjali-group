...
content = "Chandigarh University is top ranked private university in Punjab and India, CU is committed to provide continually enhanced and integrated learning environment." / >
    <
    meta name = "keywords"
content = "vision and mission chandigarh university, chandigarh university vision, chandigarh university mission, cu vision, cu mission, chandigarh university, cu" / >
    <
    meta name = "country"
content = "in" / >
    <
...
content = "INDEX, FOLLOW" / >
    <
    link rel = "canonical"
href = "https://www.cuchd.in/404.php" / >
    <
...
content = "Page Not Found | Chandigarh University (CU)" >
    <
    meta property = "og:description"
content = "Chandigarh University is top ranked private university in Punjab and India, CU is committed to provide continually enhanced and integrated learning environment." >
    <
    meta property = "og:url"
content = "https://www.cuchd.in/404.php" / >
    <
    meta http - equiv = "Content-Type"
content = "text/html; charset=utf-8" / >
    <
...
href = "new-assets/images/fevicon.png"
type = "image/x-icon" >

    <
    link rel = "preload"
href = "new-assets/css/fonts/slick.woff"
as = "font"
type = "font/woff"
crossorigin >
    ...
    <
    link rel = "preload"
href = "/latest-assets/fonts/proximanova-thin.woff2"
as = "font"
type = "font/woff2"
crossorigin >
    <
    link rel = "preload"
href = "/latest-assets/fonts/proximanova-light.woff2"
as = "font"
type = "font/woff2"
crossorigin >
    <
    link rel = "preload"
href = "/latest-assets/fonts/proximanova-regular.woff2"
as = "font"
type = "font/woff2"
crossorigin >
    <
    link rel = "preload"
href = "/latest-assets/fonts/proximanova-semibold.woff2"
as = "font"
type = "font/woff2"
crossorigin >
    <
    link rel = "preload"
href = "/latest-assets/fonts/proximanova-bold.woff2"
as = "font"
type = "font/woff2"
crossorigin >
    <
    link rel = "preload"
href = "/latest-assets/web-fonts/fa-solid-900.woff2"
as = "font"
type = "font/woff2"
crossorigin >
    <
    link rel = "preload"
href = "/latest-assets/web-fonts/fa-brands-400.woff2"
as = "font"
type = "font/woff2"
crossorigin >
    ...
    <
    link rel = "stylesheet"
href = "new-assets/fonts/fontawesome/css/fontawesome.min.css" >
    <
    link rel = "stylesheet"
href = "new-assets/fonts/fontawesome/css/brands.css" >
    <
    link rel = "stylesheet"
href = "new-assets/fonts/fontawesome/css/solid.css" >

    <
    link href = "/latest-assets/css/main-2024.css?v=1.50"
rel = "stylesheet" >

    <
    link rel = "apple-touch-icon"
sizes = "57x57"
href = "add_to_homescreen/apple-icon-57x57.png" >
    <
    link rel = "apple-touch-icon"
sizes = "60x60"
href = "add_to_homescreen/apple-icon-60x60.png" >
    <
    link rel = "apple-touch-icon"
sizes = "72x72"
href = "add_to_homescreen/apple-icon-72x72.png" >
    <
    link rel = "apple-touch-icon"
sizes = "76x76"
href = "add_to_homescreen/apple-icon-76x76.png" >
    <
    link rel = "apple-touch-icon"
sizes = "114x114"
href = "add_to_homescreen/apple-icon-114x114.png" >
    <
    link rel = "apple-touch-icon"
sizes = "120x120"
href = "add_to_homescreen/apple-icon-120x120.png" >
    <
    link rel = "apple-touch-icon"
sizes = "144x144"
href = "add_to_homescreen/apple-icon-144x144.png" >
    <
    link rel = "apple-touch-icon"
sizes = "152x152"
href = "add_to_homescreen/apple-icon-152x152.png" >
    <
    link rel = "apple-touch-icon"
sizes = "180x180"
href = "add_to_homescreen/apple-icon-180x180.png" >
    <
    link rel = "icon"
type = "image/png"
sizes = "192x192"
href = "add_to_homescreen/android-icon-192x192.png" >
    <
    link rel = "icon"
type = "image/png"
sizes = "32x32"
...
content = "add_to_homescreen/ms-icon-144x144.png" >
    <
...
noscript >
    <
    iframe src = "//www.googletagmanager.com/ns.html?id=GTM-WGZBMSV"
height = "0"
width = "0"
...
<
link href = "../../latest-assets/css/header-footer.min.css?v=1.0"
rel = "stylesheet" >
...
/script> <
link href = "new-assets/css/courses.css"
rel = "stylesheet" >
    <
    link href = "new-assets/css/inner-page.css"
rel = "stylesheet" >
    <
    link href = "migration/assets/css/style.css"
rel = "stylesheet" > <!-- CUSTOM CSS FOR THIS PAGE -->        
...
@media only screen and(min - width: 1199 px) {
    ...
    Register Now
for CU Joint Campus Placement Programme < a href = "https://www.cuchd.in/placements/frmRegistration.aspx?Type=jpp2019"
target = "_blank"
class = "xs-btn" > Register Now < /a> <
    /div> <
    div class = "whatsNew-slider__item" > Value Added Course: Essential oils and their application in
    Fragrance and Flavour Industry(July - Dec 2024) < a href = "https://www.cuchd.in/value-added-course/eoff"
target = "_blank"
class = "xs-btn" > Register Now < /a> <
    /div> <
    /div> <
...
style = "font-size: 12px" > < /i><span>360<sup>o</sup > < /span></a > < /li> <
    ...
    <
    li > < a href = "https://www.facebook.com/chandigarhuniversitygharuan"
target = "_blank"
aria - label = "Go to Chandigarh University's Facebook Page" > < i
class = "fa-brands fa-facebook-f" > < /i></a > < /li>

    <
    li > < a href = "https://www.twitter.com/chandigarh_uni"
target = "_blank"
aria - label = "Go to Chandigarh University's Twitter (X) Page" >
    ...
    <
    li > < a href = "https://www.linkedin.com/school/chandigarh-university/"
target = "_blank"
aria - label = "Go to Chandigarh University's Linkedin Page" > < i
class = "fa-brands fa-linkedin-in" > < /i></a > < /li>

    <
    li > < a href = "https://www.instagram.com/chandigarhuniversity"
target = "_blank"
aria - label = "Go to Chandigarh University's Instagram Page" > < i
class = "fa-brands fa-instagram" > < /i></a > < /li>

    <
    li > < a href = "https://www.youtube.com/user/chandigarhuniversity"
target = "_blank"
aria - label = "Go to Chandigarh University's Youtube Page" > < i
class = "fa-brands fa-youtube" > < /i></a > < /li>

    <
    li > < a href = "https://www.threads.net/@chandigarhuniversity"
target = "_blank"
...
aria - label = "Go to Chandigarh University's Home Page" >
    <
    img src = "includes/assets/images/header-footer/cu-logo-white.webp"
alt = ""
width = "210"
class = "me-2 cu-logo" >
    <
    ...
    <
    a href = "tel:+1800121288800"
class = "d-flex align-items-center text-white" >
    <
    img src = "includes/assets/images/header-footer/phone-icon.webp"
alt = ""
width = "30" >
    <
...
aria - label = "Search Chandigarh University Website"
...
aria - label = "Go to Chandigarh University's Home Page" >
    <
    img src = "includes/assets/images/header-footer/cu-logo-dark.webp"
alt = ""
width = "180"
class = "me-2 cu-logo" >
    <
...
id = "navbarCollapse" >
    ...
    a href = "https://www.cuchd.in/" >
    <
    img src = "includes/assets/images/header-footer/cuchd-icon.webp"
alt = ""
class = "w-100"
width = "70" >
    <
    ...
    div class = "col-6" >
    <
    a href = "http://www.culko.in/"
target = "_blank" >
    <
    img src = "includes/assets/images/header-footer/culko-icon.webp"
alt = ""
class = "w-100"
width = "70" >
    <
...
aria - hidden = "true" > < /i><span>Search</span > < /a> <
    ...
    <
    li > < a href = "about/our-identity.php" > Our Identity < /a> <
    /li> <
    li > < a href = "about/vision-and-mission.php" > Vision & amp;
Mission < /a> <
    /li> <
...
Rankings < /a> <
    /li> <
    li > < a
href = "about/institution-social-responsibility.php" > Institutional
Social Responsibility < /a> <
    ...
    ul class = "list-unstyled p-0 m-0" >
    <
    li > < a href = "academics/institutes.php" > Institutes & amp;
Departments < /a> <
    /li> <
...
Facility < /a> <
    /li> <
    li > < a href = "student-services/" > Student Services < /a> <
    /li> <
...
data - bg = "includes/assets/images/header-footer/about-dd-image.webp" >
    ...
    <
    h3 > Chandigarh University < span > Best Educational < /span> Institution</h
3 >
    <
...
class = "fas fa-arrow-circle-down ms-1" > < /i></strong >
    ...
    <
    a rel = "nofollow"
href = "https://www.cuidol.in"
class = "nav-link" >
    <
    small > Click here to view Programs of < /small> <
    strong > Open & amp;
Distance Learning(ODL) < i
...
class = "fas fa-external-link-alt ms-1" > < /i></strong >
    ...
    <
    li > < a
href = "engineering/" > Engineering < /a> <
    /li> <
    li > < a href = "management/" > Management(BBA / MBA) < /a> <
    /li> <
    li > < a href = "apex-management/" > Management - Apex <
    /a> <
    /li> <
    li > < a href = "computing/" > Computing(BCA /
        MCA) < /a> <
    /li> <
    li > < a
...
Airport Management < /a> <
    /li> <
    li > < a
href = "animation-and-multimedia/" > Animation &
    amp;
Multimedia < /a> <
    /li> <
...
href = "architecture-and-design/" > Architecture < /a> <
    /li> <
    li > < a
href = "liberal-arts-and-humanities/" > Arts &
    amp;
Humanities < /a> <
    /li> <
...
Sciences < /a> <
    /li> <
    li > < a
href = "liberal-arts-and-humanities/bachelor-of-arts-liberal-arts.php" > BA(Hons.) Liberal Arts < /a> <
    /li> <
    li > < a href = "biotechnology/" > Biotechnology &
    amp;
Biosciences < /a> <
    /li> <
    li > < a
...
Science < /a> <
    ...
    ul class = "list-unstyled p-0 m-0" >
    <
    li > < a href = "basic-sciences/" > Chemistry /
    Physics / Mathematics < /a> <
    /li> <
    li > < a href = "commerce/" > Commerce(B.Com) < /a> <
    /li> <
    li > < a
...
Sciences < /a> <
    ...
    /li> <
    li > < a
href = "teachers-training-and-research/" > Education(B.A.B.Ed / B.Sc.B.Ed) < /a> <
    /li> <
    li > < a
href = "design/bachelor-of-design-fashion.php" > Fashion &
    amp;
Design < /a> <
    /li> <
...
Arts < /a> <
    /li> <
    li > < a href = "finance-and-accounting" > Finance &
    Accounting <
    /a> <
    /li> <
    li > < a
href = "applied-health-sciences/msc-in-forensic-and-toxicology.php" > Forensic
Sciences < /a> <
    /li> <
    li > < a
href = "hotel-management-and-tourism/" > Hotel &
    amp;
...
CSE Programs < /a> <
    /li> <
    li > < a
href = "biotechnology/msc-industrial-microbiology.php" > Microbiology < /a> <
    /li> <
    li > < a
href = "design/bachelor-of-design.php" > Product &
    amp;
Industrial
Design < /a> <
    /li> <
    li > < a
href = "design/bachelor-of-design-interior.php" > Interior
Design < /a> <
    /li> <
    /ul> <
    /div> <
...
Studies < /a> <
    /li> <
    li > < a
href = "management/mba-healthcare-and-life-sciences.php" > MBA
...
and Tourism < /a> <
    /li> <
    li > < a
href = "finance-and-accounting/bba-acca.php" > BBA
with < img
...
class = "lazy-img" > < /a> <
    /li> <
    li > < a
href = "finance-and-accounting/bcom-acca.php" > B.Com
with < img
data - src = "includes/assets/images/header-footer/acca-header-logo.webp"
alt = "B.Com with ACCA"
width = "30px"
class = "lazy-img" > < /a> <
    ...
    <
    li > < a
href = "finance-and-accounting/mcom-acca.php" > M.Com
with < img
data - src = "includes/assets/images/header-footer/acca-header-logo.webp"
alt = "M.Com with ACCA"
width = "30px"
...
class = "ptrans lazy-img" > < /a> <
    /li> <
    li > < a
href = "IBM/MBA-business-analytics.php" > MBA
with < img
...
class = "ptrans lazy-img" > < /a> <
    /li> <
    li > < a
href = "finance-and-accounting/mba-applied-finance.php" > MBA in Applied Finance with < img
...
class = "ptrans lazy-img" > < /a> <
    /li> <
    li > < a
href = "management/mba-fintech.php" > MBA
Fintech with < img
...
class = "ptrans lazy-img" > < /a> <
    /li> <
    li > < a
href = "management/MBA-logistics-and-supply-chain-management.php" > MBA
...
class = "ptrans lazy-img" > < /a> <
    ...
    ul class = "list-unstyled p-0 m-0" >
    <
    li > < a href = "doctorate-programs/" > Doctor of Philosophy < /a> <
    /li> <
    /ul> <
    /div> <
    div class = "col-md-6" >
...
Admissions < /a> <
    ...
    ul class = "list-unstyled p-0 m-0" >
    <
    li > < a href = "studyabroad/" > Canada < /a> <
    /li> <
    /ul> <
    /div> <
    div class = "col-md-3" >
...
data - bg = "includes/assets/images/header-footer/program-dd-image.webp" >
    ...
    <
    h3 > University with < span > Best Placements < /span></h
3 >
    <
...
class = "d-none" > < /span>54.75                                                                        <sub>LPA</sub >
    ...
    <
    li > < a href = "academics/institutes.php" > Institutes < /a> <
    /li> <
...
Project based & Experiential Learning <
    ...
    ul class = "list-unstyled p-0 m-0" >
    <
    li > < a href = "admissions/after12th.php" > After
12 th < /a> <
    /li> <
...
Programs < /a> <
    /li> <
    li > < a
href = "admissions/specialized-programs.php" > Specialized
Programs < /a> <
    /li> <
    li > < a
href = "admissions/integrated-programs.php" > Integrated
Programs < /a> <
    /li> <
    li > < a
href = "admissions/afterpostgraduation.php" > After
Post Graduation < /a> <
    /li> <
    li > < a href = "admissions/cu-advantages.php" > CU
Advantages < /a> <
    /li> <
    li > < a href = "abet/" > ABET Engineering
Accreditation < /a> <
    /li> <
    /ul> <
    /div> <
...
Fee < /a> <
    /li> <
    li > < a href = "admissions/how-to-apply.php" > How
to
Apply ? < /a> <
    /li> <
    li > < a
href = "admissions/admission-criteria.php" > Admission
Criteria < /a> <
    /li> <
    li > < a href = "scholarship/" > CU Scholarship < /a> <
    /li> <
    li > < a href = "admissions/education-loan.php" > Education
Loan < /a> <
    /li> <
    li > < a
href = "student-services/hostel-facility.php" > Hostel
Fee < /a> <
    /li> <
    /ul> <
    /div> <
...
Offices < /a> <
    /li> <
    li > < a href = "contact/" > Visit the Campus < /a> <
    /li> <
    li > < a href = "migration/" > Migration Policy < /a> <
    /li> <
...
href = "campus-life/live-concerts.php" > Live - in -Concerts < /a> <
    /li> <
    li > < a href = "campus-life/tech-invent.php" > Tech
Invent
    &
    amp;
Events < /a> <
...
Cosmopolitan < /a> <
    /li> <
    li > < a href = "campus-life/evoke.php" > Evoke & amp;
Youth
Summits < /a> <
    /li> <
    li > < a
href = "campus-life/glorious-stars-cu.php" > Glorious
Stars at CU < /a> <
    /li> <
...
Adventure < /a> <
    /li> <
    li > < a href = "latest-news/index.php" > Latest
News < /a> <
    /li> <
    /ul> <
    /div> <
    ...
    <
    li > < a
href = "campus-life/bollywood-celebrities.php" > Bollywood
Celebrities < /a> <
    /li> <
...
Alumni < /a> <
    /li> <
    li > < a
href = "campus-life/canadian-alumni-meet.php" > Canadian
Alumni Chapter < /a> <
    /li> <
    /ul> <
    /div> <
...
data - bg = "includes/assets/images/header-footer/placement-bg.webp" >
    ...
    div class = "drop-down-graphic position-relative h-100" >
    <
    h3 > Most sought after < span > Destination < /span>of blue-chip companies</h
3 >
    <
...
target = "_blank" > Department of Career Planning & amp;
Development < /a> <
    /li> <
...
Management Placement < /a> <
    /li> <
    li > < a
href = "placements/placement_hotel_management.php" > Best
...
Physics Placement < /a> <
    /li> <
    li > < a href = "placement-offers-by-tcs/index.php" > Best
TCS Placement < /a> <
    /li> <
    li > < a href = "placements/placement-day.php" > Placement
Day < /a> <
    /li> <
    li > < a href = "placements/placement-overview.php" > Our
Leading
Recruiters < /a> <
    /li> <
    /ul> <
    ...
    li class = "nav-item dd-menu-lg" >
    <
    a href = "javascript:void(0);" > Research & amp;
Innovation < /a> <
...
4 >
    ...
    <
    li > < a href = "research/patents.php" > Patents < /a> <
    /li> <
    li > < a href = "research/center-of-research.php" > Centers
Of Research < /a> <
    /li> <
    li > < a
href = "research/centers-of-excellence.php" > Centers of Excellence < /a> <
    /li> <
    li > < a href = "research/scholars.php" > Visiting
Scholars < /a> <
    /li> <
    li > < a
href = "usb/business-management/research-journal.php" > CU
Global Management Review < /a> <
    /li> <
    li > < a
href = "uils/legal-studies/research-journal.php" > CU
Law Review < /a> <
    /li>
<!-- <li><a href="ignite/"
...
Entrepreneurship Development Cell(IEDC) < /a> <
    ...
    h4 class = "mt-lg-4" > Sustainable Development Goals(SDG 's)</h4> <
        ...
        ul class = "list-unstyled p-0 m-0" >
        <
        li > < a href = "research/sdg" > Policies & amp; Strategies < /a> <
        /li> <
        /ul> <
        /div> <
        /div> <
        ...
        <
        h5 class = "text-white" > A New Era in Engineering Education awaits you with dynamic experiential learning and a flexible academic model. <
        /h5> <
        div class = "btn-grp" >
        <
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Embark on your path to corporate leadership with world - class facilities, research focus, innovation culture &
        amp; entrepreneurial zeal. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Gain the ultimate toolkit
        for success in
        computing with our versatile degree and hands - on learning experience. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Seize the unparalleled opportunity to become a future Healthcare Pro & amp; immerse yourself in a clinically focused, science - driven course. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        Biotechnology and Biosciences within our research - oriented environment. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Master architecture as core professionals with cutting - edge tech and insights from the global community. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        li >
        <
        a href = "/liberal-arts-and-humanities/" > University Institute of Liberal Arts & amp; Humanities < /a> <
        div class = "step-second-menu institute-info-sec bg-transparent p-0" >
        <
        div class = "row g-0 h-100" >
        <
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Step into a hub of cultural diversity, where learning centers on critical thinking, creativity, research, and communication skills. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        merging technology with traditional art
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Your pathway to becoming an exceptional educator with NCTE approval, collaborative partnerships and much more. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Become a top - notch Legal Professional a blend of tradition and modernity in Legal Education. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Your path to industry - ready media professionalism with hands - on training, a dynamic environment &
        amp; global collaborations. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Lead the forefront of Allied Health Sciences with a clinically focused curriculum and immersive learning experience. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Embark on your journey with our comprehensive Design programs, guided by experienced faculty & amp; tailored
        for success. <
        /h5> <
        div class = "btn-grp" >
        <
        ...
        li >
        <
        a href = "/hotel-management-and-tourism/" > University Institute of Tourism & amp; Hospitality Management < /a> <
        div class = "step-second-menu institute-info-sec bg-transparent p-0" >
        <
        div class = "row g-0 h-100" >
        <
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Lead the way in hospitality education with cutting - edge training, facilities & amp; a unique blend of
        theoretical knowledge & amp; real - world experience. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Unveil a revolutionary approach to finance education with dynamic experiential learning. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        <
        a href = "/cassm/" > Centre
        for Advanced Studies in Social Science and Management < /a> <
        div class = "step-second-menu institute-info-sec bg-transparent p-0" >
        <
        div class = "row g-0 h-100" >
        <
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Embrace a new era of dynamic learning & amp; flexibility in social science and management education. <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        div class = "institute-content d-flex flex-column  justify-content-between h-100 p-5" >
        <
        h5 class = "text-white" > Lead the way in physical education with emphasis on fundamental principles, psychological aspects, and leadership development <
        /h5> <
        div class = "btn-grp" >
        <
        a href = "https://cucet.cuchd.in/index.aspx?utm_source=Website&utm_medium=cuchd"
        ...
        <
        div class = "banner-img banner-h"
        style = "height: 350px !important; background: #172b5a;" >
        <
        ...
        ul class = "ps-0" >
        <
        li > < a href = "https://www.cuchd.in" > Home < /a></li > < li > < a class = "bread_crumb"
        href = "https://www.cuchd.in/404.php" > 404. php < /a></li > < /ul> <
        /div>						 <
        /div>
        ...
        id = "exampleModalLabel" > Search below to find what you are looking
        for: < /h5> <
        /div> <
        div class = "modal-body pt-2 text-center" >
        <
        form class = "position-relative"
        action = "https://www.cuchd.in/searchresult.php"
        method = "get" >
        <
        input type = "text"
        ...
        a href = "https://www.cuchd.in/"
        class = "text-red home-link" > < strong > Go to Home Page < /strong></a >
        <
        /p>                         <
        /div> <
        ...
        <
        img src = "migration/assets/images/top-nav-image.jpg"
        ...
        src = "migration/assets/images/phone-white-icon.png"
        alt = "phone call icon" >
        <
        /div> <
        ...
        a href = "tel:+1800121288800"
        class = "text-white" > 1800121288800 < /a> <
        /div>        <
        /div>                <
        /div>  <
        div class = "ab-link" >
        ...
        <
        li > < a href = "/about/"
        title = "OChandigarh University Overview"
        onclick = "highlite(this);" > Overview < /a></li >
        <
        li > < a href = "/about/our-identity.php"
        title = "About Our Seal"
        onclick = "highlite(this);" > Our Identity < /a></li >
        <
        li > < a href = "/about/vision-and-mission.php"
        title = "Chandiagrh University Vission and Mission"
        onclick = "highlite(this);" > Vision and Mission < /a></li >
        <
        li > < a href = "/about/LeaderShip.php"
        title = "LeaderShip"
        onclick = "highlite(this);" > Leadership < /a></li >
        <
        li > < a href = "/about/governance.php"
        title = "Governance"
        onclick = "highlite(this);" > Governance < /a></li >
        <
        li > < a href = "/recognitions-and-approvals/"
        title = "Reconization and Aprovals"
        onclick = "highlite(this);" > Recognition and Aprovals < /a></li >
        <
        li > < a href = "/about/Awards-and-Rankings.php"
        title = "Awards and Rankings"
        onclick = "highlite(this);" > Awards and Rankings < /a></li >
        <
        li > < a href = "/about/institution-social-responsibility.php"
        title = "Institution Social Responsibility"
        onclick = "highlite(this);" > Institution Social Responsibility < /a></li >
        <
        /div>
        ...
        title = "Our Institutes &amp; Departments" > Our Institutes & amp; Departments < /a></li >
        <
        li > < a href = "/admissions/"
        title = "Admissions" > Admissions < /a></li >
        <
        li > < a href = "/scholarship/"
        title = "Scholarships" > Scholarships < /a></li >
        <
        li > < a href = "/admissions/cu-edge.php"
        title = "CU Advantages" > CU Edge < /a></li >
        <
        li > < a href = "/student-services/hostel-facility.php"
        title = "Hostel facility" > Hostel Facility < /a></li >
        <
        li > < a href = "/student-services/"
        title = "Student Services" > Student Services < /a></li >
        <
        li > < a href = "/contact/how-to-reach-us.php"
        title = "How to Reach Us?"
        onclick = "highlite(this);"
        class = "br-6" > How to Reach Us ? < /a></li >
        <
        /div> <
        /ul>     <
        /div> <
        ...
        <
        li > < a href = "/admissions/" > CU Admissions < /a></li >
        <
        li > < a href = "/admissions/education-loan.php" > CU Education Loan < /a></li >
        <
        li > < a href = "/admissions/how-to-apply.php" > How to Apply ? < /a></li >
        <
        li > < a href = "/scholarship/" > CU Scholarship < /a></li >
        <
        li > < a href = "/contact/index.php" > CU Admission Office < /a></li >
        <
        li > < a href = "/iqac/student-feedback-form.php" > CU Student Feedback < /a></li >
        <
        li > < a href = "/online-request/" > CU Student Facilitation < /a></li >
        <
        li > < a href = "/online-request/esanad.php" > eSanad < /a></li >
        <
        li > < a href = "/chandigarh-university-create-guinness-world-record/" > Guinness World Records < /a></li >
        <
        /ul> <
        /div> <
        div class = "col-6 col-sm-4 col-lg-2" >
        ...
        <
        li > < a href = "/organogram/index.php" > Organogram < /a></li >
        <
        li > < a href = "/committee/index.php" > Other Committees < /a></li >
        <
        li > < a href = "https://uims.cuchd.in/uims/"
        target = "_blank" > Pay Fee Online < /a></li >
        <
        li > < a href = "/academics/institutes.php" > CU Institutes < /a></li >
        <
        li > < a href = "/academics/teaching-practices.php" > Teaching Practices < /a></li >
        <
        li > < a href = "/academics/system-of-evaluation.php" > System of Evaluation < /a> <
        /li> <
        li > < a href = "/placements/" > CU Placements < /a></li >
        <
        li > < a href = "/admissions/cu-edge.php" > CU Edge < /a></li >
        <
        li > < a href = "/qs-asia-rankings-2024/"
        target = "_blank" > QS Asia Rankings 2024 < /a></li >
        <
        li > < a href = "/>nirf-2024/"
        target = "_blank" > NIRF Rankings 2024 < /a></li >
        <
        li > < a href = "/cu-unnao-campus-gets-nod-from-up-government/"
        ...
        <
        li > < a href = "/grievance/index.php" > Grievance < /a></li >
        <
        li > < a href = "https://news.cuchd.in"
        target = "_blank" > CU News < /a></li >
        <
        li > < a href = "https://blog.cuchd.in"
        target = "_blank" > CU Blog < /a></li >
        <
        li > < a href = "https://alumni.cuchd.in/" > Alumni < /a></li >
        <
        li > < a href = "/maps/" > Maps < /a></li >
        <
        li > < a href = "/maps/" > Distance Calculator < /a></li >
        <
        li > < a href = "/contact/about-chandigarh.php" > About Chandigarh < /a></li >
        <
        li > < a href = "/new-assets/images/ODL-Application-Chandigarh-University.pdf"
        target = "_blank" > Application Submitted to UGC - DEB < /a></li >
        <
        li > < a href = "/qs-world-ranked-private-university-in-india/"
        target = "_blank" > QS World University Rankings < /a></li >
        <
        li > < a href = "/abet-engineering-accreditation/"
        target = "_blank" > ABET Accreditation < /a></li >
        <
        /ul> <
        /div> <
        div class = "col-6 col-sm-4 col-lg-2" >
        ...
        ul class = "m-0 list-unstyled" >
        <
        li > < a href = "/student-services/hostel-facility.php" > CU Hostels < /a></li >
        <
        li > < a href = "/student-services/transport-facility.php" > CU Transport < /a></li >
        <
        li > < a href = "/student-services/sports.php" > CU Sports < /a></li >
        <
        li > < a href = "/student-services/cultural.php" > Cultural Activities < /a></li >
        <
        li > < a href = "/student-services/studen-welfare-services.php" > CU Student Welfare < /a></li >
        <
        li > < a href = "/student-services/libraries.php" > CU Libraries < /a></li >
        <
        li > < a href = "/anti-ragging-policy/anti-ragging-policy.php" > Anti - Ragging Policy < /a></li >
        ...
        ul class = "m-0 list-unstyled" >
        <
        li > < a href = "/admissions/course-fee.php" > Courses Fee Details < /a></li >
        <
        li > < a href = "/grievance-redressal-cell/" > Grievance Redressal Cell < /a></li >
        <
        li > < a href = "/ombudsperson/" > Ombudsperson < /a></li >
        <
        li > < a href = "/assets/upload/procedures-and-policies-for-maintenance.pdf" > Procedures And Policies < /a></li >
        <
        li > < a href = "/ppcb-report/"
        target = "_blank" > PPCB Report < /a></li >
        <
        li > < a href = "/mandatory-disclosure.php" > Mandatory Disclosure < /a></li >
        <
        li > < a href = "/disclaimer.php" > Disclaimer < /a></li >
        <
        li > < a href = "/new-assets/images/notification-high-court.pdf"
        target = "_blank"
        ...
        <
        li > < a href = "/chandigarh-university-ranked-naac-a-plus-grade-university/" > NAAC < /a> <
        /li> <
        li > < a href = "/nirf" > NIRF < /a></li >
        <
        li > < a href = "/assets/upload/nats.pdf"
        target = "_blank" > NATS < /a></li >
        <
        ...
        rel = "nofollow"
        target = "_blank"
        aria - label = "Go to Chandigarh University's Facebook Page" > < i class = "fab fa-facebook"
        aria - hidden = "true" > < /i></a > < /li> <
        li > < a href = "https://twitter.com/Chandigarh_uni"
        rel = "nofollow"
        target = "_blank"
        aria - label = "Go to Chandigarh University's Twitter (X) Page" > < img src = "includes/assets/images/header-footer/twitter-icon.webp"
        alt = ""
        height = "12"
        class = "f-twitter-icon" > < /a></li >
        <
        li > < a href = "http://www.pinterest.com/chandigarhunive/boards/"
        rel = "nofollow"
        target = "_blank"
        aria - label = "Go to Chandigarh University's Pinterest Page" > < i class = "fab fa-pinterest"
        aria - hidden = "true" > < /i></a > < /li> <
        li > < a href = "http://www.instagram.com/chandigarhuniversity/"
        rel = "nofollow"
        target = "_blank"
        ...
        rel = "nofollow"
        target = "_blank"
        aria - label = "Go to Chandigarh University's Linkedin Page" > < i class = "fab fa-linkedin"
        aria - hidden = "true" > < /i></a > < /li> <
        li > < a href = "https://www.youtube.com/user/chandigarhuniversity"
        rel = "nofollow"
        target = "_blank"
        ...
        li > < a href = "https://www.threads.net/@chandigarhuniversity"
        target = "_blank"
        aria - label = "Go to Chandigarh University's Threads Page" > < img src = "includes/assets/images/header-footer/threads-icon.webp"
        alt = ""
        height = "14" > < /a></li >
        <
        /ul> <
        ...
        <
        a href = "/radio-punjab-90/"
        target = "_blank"
        class = "w-100" >
        <
        img class = "lazyload"
        data - src = "includes/assets/images/header-footer/radio-punjab-logo.webp"
        alt = "Radio Punjab 90.0"
        title = "Radio Punjab 90.0"
        width = "110" >
        <
        /a> <
        /div> <
        ...
        <
        img class = "lazyload"
        data - src = "includes/assets/images/header-footer/virtual-tour-logo-w.webp"
        ...
        target = "_blank"
        style = "color: var(--text-skyblue);" > Apply Now < /a> at India's Best Private University in Punjab, Chandigarh which provides top placements.</p >
        <
        /div> <
        ...
        data - src = "includes/assets/images/header-footer/unai-logo.webp"
        alt = "UNAI" >
        <
        /div> <
        /div> <
        ...
        button type = "button"
        class = "page-scroll"
        aria - label = "Chandigarh University Homepage" > APPLY NOW
        for CUCET - 2025 < /button> <
        /div>
        ...
        <
        button type = "button"
        class = "allNotification__icon"
        aria - label = "Chandigarh University Notifications" > < i class = "fa-solid fa-bell" > < /i></button >
        <
        ...
        li class = "shadow" >
        <
        a href = "https://www.cuchd.in/techinvent/"
        target = "_blank" >
        <
        h6 > TECH INVENT 2024 < /h6> <
        p > A Convergence of Creativity and Innovation < /p> <
        ...
        <
        h5 class = "modal-title"
        id = "exampleModalLabel" > Search the website here < /h5> <
        button type = "button"
        class = "btn-close"
        data - bs - dismiss = "modal"
        aria - label = "Close" > < /button> <
        ...
        <
        button type = "button"
        class = "gotoTop__icon" > < i class = "fa fa-arrow-circle-up"
        ...
        defer > < /script> <!-- Fix for City dropdown position on updating jquery from v2.1.2 to v3.6 -->
        ...
        script src = "/new-assets/js/main-landing.js?v=1.25"
        defer > < /script> 
        ...
        $('.allNotification__list').addClass(window.localStorage.toggled); $('.allNotification__icon').on('click', function() {
        ...
        window.$superbot || (function(d, s) {
            ...
            $.src = "https://app.superbot.works/agent.js?a=lDPgYnOLmd&l=en";
            _sb.t = +new Date;
